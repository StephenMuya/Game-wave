                ...
                <main className="questions">
                    <div className="question">
                        <h2>What is Frontend Mentor, and how will it help me?
                            <svg className="plus" xmlns="http://www.w3.org/2000/svg" width="30" height="31" fill="none" viewBox="0 0 30 31">
                            ...
                            <svg className="minus" xmlns="http://www.w3.org/2000/svg" width="30" height="31" fill="none" viewBox="0 0 30 31">
